...
void PrintArrayD(CBLAS_ORDER *order, int flag1, int flag2, MKL_INT *m, MKL_INT *n, double *a,
                MKL_INT *lda, char *name)
{
        MKL_INT i, j;
        double  *addr;
...
void PrintArrayC(CBLAS_ORDER *order, int flag1, int flag2, MKL_INT *m, MKL_INT *n, MKL_Complex8 *a,
                MKL_INT *lda, char *name)
{
        MKL_INT  i, j;
        MKL_Complex8 *addr;
...
void PrintBandArrayS(CBLAS_ORDER *order, int flag,
...
void PrintBandArrayD(CBLAS_ORDER *order, int flag,
                     MKL_INT kl, MKL_INT ku, MKL_INT m, MKL_INT n,
...
void PrintBandArrayC(CBLAS_ORDER *order, int flag,
                     MKL_INT kl, MKL_INT ku, MKL_INT m, MKL_INT n,
...
void PrintBandArrayZ(CBLAS_ORDER *order, int flag,
                     MKL_INT kl, MKL_INT ku, MKL_INT m, MKL_INT n,
